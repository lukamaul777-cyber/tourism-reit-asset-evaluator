...
## Target Users
- Tourism asset operators
- Hotel and resort management teams
- Cultural tourism investment teams
- Infrastructure REITs project screening teams
- Tourism management / business analytics portfolio reviewers

## Key Features
- Regulatory Gatekeeper
- Reference-Based REITs Suitability Score
...
1. Regulatory-style Gatekeeper for pre-screening
2. 100-point reference-based scoring model
