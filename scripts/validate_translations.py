...
CRITICAL_KEYS = {
    ...
    "indicator.title",
    "score.title",
    "score.module_a_indicator_details_title",
    "score.module_a_indicator_details_note",
    "score.indicator_id",
    "score.indicator_name",
    "score.raw_value",
    "score.normalized_score",
    "score.direction",
    "score.included_in_score",
    "score.data_note",
    "score.included_yes",
    "score.included_no",
    "score.missing",
    ...
    "field_source.note",
    "field_source.fields",
    "field_source.verified_public",
    "field_source.model_derived",
    "field_source.estimated_demo_proxy",
    "field_source.unknown",
    "field_source.legend_note",
    "field_source.module_a_note",
    "field_source.report_note",
    "risk.title",
    "validity.title",
    "scenario.title",
    ...
    "data_source.verified_missing_fallback",
    "data_source.current_financial_data_source",
    "data_quality.title",
    "data_quality.subtitle",
    "data_quality.disclaimer",
    "data_quality.data_confidence_score",
    "data_quality.data_confidence_level",
    "data_quality.completeness",
    "data_quality.source_reliability",
    "data_quality.traceability",
    "data_quality.timeliness",
    "data_quality.coverage",
    "data_quality.levels.high_data_confidence",
    "data_quality.levels.moderate_high_data_confidence",
    "data_quality.levels.moderate_data_confidence",
    "data_quality.levels.low_data_confidence",
    "data_quality.levels.very_low_data_confidence",
    "data_quality.explanations.completeness",
    "data_quality.explanations.source_reliability",
    "data_quality.explanations.traceability",
    "data_quality.explanations.timeliness",
    "data_quality.explanations.coverage",
    "data_quality.warning_source_reliability",
    "data_quality.warning_traceability",
    "data_quality.warning_completeness",
    "data_quality.verified_metadata",
    "data_quality.verified_metadata_unavailable",
    "data_quality.tables.assets",
    "data_quality.tables.overall",
    "data_quality.data_types.mixed",
    "data_quality.data_types.simulated",
    "columns.asset_id",
    "columns.asset_name",
    "columns.total_score",
    ...
    "columns.source_note",
    "columns.data_type",
    "columns.data_confidence_score",
    "columns.data_confidence_level",
